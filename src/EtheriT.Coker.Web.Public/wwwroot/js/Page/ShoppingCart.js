...
function IsECPaySelected() {
    ...
    return HasECPay && (($checked.length > 0 && IsPaymentRadioECPay($checked)) || $("#ECPayPayment .ecpay-pay-list-wrap .ecpay-pay-list > li.ecpay-pl-act").length > 0);
}
...
async function OrderHeaderAdd() {
    ...
    if (typeof (order_header_data.payment) == "undefined" && $(`[name="RadioPayment"]`).length > 0) {
    ...
    Coker.Order.CheckStock(data).done(async function (result) {
        ...
        if (isECPayCheckout) {
            ...
            ValidateECPayPayment(function (success, result) {
                if (success) {
                    AddHeader(result);
                } else {
                    Coker.sweet.warning(
                ...
                function () {
                    ...
                    setTimeout(function () {
                        ...
                        switch (paymenttype) {
                            ...
                            case "ECPay":
                                co.sweet.loading();
                                if (order_header_data.payment != 27 && paymentInfo != null) {
