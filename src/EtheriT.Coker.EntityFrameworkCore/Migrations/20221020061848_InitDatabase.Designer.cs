...
namespace EtheriT.Coker.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20221020061848_InitDatabase")]
            ...
            modelBuilder.Entity("EtheriT.Coker.Core.Models.MappingUserAndWebsite", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationTime = new DateTime(2022, 10, 20, 14, 18, 47, 872, DateTimeKind.Local).AddTicks(6563),
                            CreatorUserId = 0L,
                            UserId = 1L,
                            WebsiteId = 1L
                        },
                        ...
                        {
                            Id = 2L,
                            CreationTime = new DateTime(2022, 10, 20, 14, 18, 47, 872, DateTimeKind.Local).AddTicks(6564),
                            CreatorUserId = 0L,
                            UserId = 2L,
                            WebsiteId = 2L
                        });
            ...
            modelBuilder.Entity("EtheriT.Coker.Core.Models.Website", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationTime = new DateTime(2022, 10, 20, 14, 18, 47, 872, DateTimeKind.Local).AddTicks(6550),
                            CreatorUserId = 0L,
                            Locale = "zh-tw",
                            Title = "Coker雲端開店大師",
                            Type = "website"
                        ...
                        {
                            Id = 2L,
                            CreationTime = new DateTime(2022, 10, 20, 14, 18, 47, 872, DateTimeKind.Local).AddTicks(6552),
                            CreatorUserId = 0L,
                            Locale = "zh-tw",
            ...
            modelBuilder.Entity("EtheriT.Coker.Web.Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationTime = new DateTime(2022, 10, 20, 14, 18, 47, 872, DateTimeKind.Local).AddTicks(6452),
                            CreatorUserId = 0L,
                        ...
                        new
                        {
                            ...
                            CreationTime = new DateTime(2022, 10, 20, 14, 18, 47, 872, DateTimeKind.Local).AddTicks(6460),
                            CreatorUserId = 0L,
