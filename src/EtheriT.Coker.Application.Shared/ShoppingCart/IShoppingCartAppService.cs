...
namespace EtheriT.Coker.Application.Shared.ShoppingCart
{
    public interface IShoppingCartAppService
    {
        ...
        public Task<ResponseMessageDto> UpdateVariant(ShoppingCartVariantUpdateDto dto);
        public Task<ResponseMessageDto> UpdateAddOnSelections(ShoppingCartAddOnSelectionUpdateDto dto);
