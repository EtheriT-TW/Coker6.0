...
namespace EtheriT.Coker.Application
{
    public interface IFileUploadAppService
    {
        ...
        public Task<UploadFileOutputDto> uploadFiles(IList<IFormFile> files, string areakey, int type,long id, long sid, int serno, string page, bool isEncryption);
        ...
        public Task<ResponseMessageDto> fileAreaKeyChange(FileChangeKeyAreaDto dto);
