...
const display_configurations = {
    ...
    [list_type.product_list]: ["type1", {
        ".bottom-row": "mt-auto",
        ".card-border": "card-border-rd type2",
        ".catalog-number": "type4-title py-0",
        ".check_btn": "check_btn-type3",
        ".col": " type5",
        ".description": "type3-content",
        ".image": "px-0",
        ...
        ".item-header": "d-none",
        ".less-tag": "d-none",
        ".like-and-share": "ms-auto fs-5 p-2",
        ".mergetag": "merge",
        ".more": "d-none",
        ".more-btn": "d-none",
        ".price-grid": "d-none",
        ...
        ".shareBlock": "type5",
        ".btn_fav": "type5",
        ".tags": "mt-auto align-text-bottom d-lg-flex",
        ".title": "type4-title px-2",
