        ...
        Coker.Product.GetHistoryDis($.cookie('Token')).done(function (result) {
            if (result.length > 0) {
                ...
                result.forEach(function (item) {
                    var history_prod = `<li class='history_prod mb-1 border bg-white' data-pid='${item.id}'><a class='pro_link' href='/Toilet/${item.id}'><img class='img-fluid' src='/images/product/pro_0${item.id}.png' alt='' /></a></li>`;
